...
WEB_REQUEST_COUNT_TREND_7D = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1d', '%m-%d-%H', '0') as time,count(*) as count group by time order by time"
WEB_REQUEST_COUNT_TREND_24H = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1h','%m-%d-%H', '0') as time,count(*) as count group by time order by time"
WEB_REQUEST_COUNT_TREND_1H = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'5m', '%H:%i:%s', '0') as time,count(*) as count group by time order by time"
DOMAIN_WEB_REQUEST_COUNT_TREND_7D = "* and  host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1d', '%m-%d-%H', '0') as time,count(*) as count group by time order by time"
DOMAIN_WEB_REQUEST_COUNT_TREND_24H = "* and  host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1h','%m-%d-%H', '0') as time,count(*) as count group by time order by time"
DOMAIN_WEB_REQUEST_COUNT_TREND_1H = "* and host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'5m', '%H:%i:%s', '0') as time,count(*) as count group by time order by time"

WEB_IP_COUNT_TREND_7D = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1d', '%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
WEB_IP_COUNT_TREND_24H = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1h','%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
WEB_IP_COUNT_TREND_1H = "*  and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'5m', '%H:%i:%s', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_WEB_IP_COUNT_TREND_7D = "* and host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1d', '%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_WEB_IP_COUNT_TREND_24H = "* and host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'1h','%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_WEB_IP_COUNT_TREND_1H = "* and host: \"{}\" and (waf_module: web_rule_protection or waf_module: web_engine_protection) | select time_series(cast(request_time as timestamp)- interval 8 hour,'5m', '%H:%i:%s', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
...
def cls_report_web_request_count_trend(request):
    return_result = {}
    try:
...
def cls_report_web_ip_count_trend(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_request_count_totle(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_request_ip_totle(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_att_type_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_att_ip_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_att_uri_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def cls_report_web_att_ip_country_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
