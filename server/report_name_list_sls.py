...
NAME_LIST_REQUEST_COUNT_TREND_7D = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,count(*) as count group by time order by time"
NAME_LIST_REQUEST_COUNT_TREND_24H = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,count(*) as count group by time order by time"
NAME_LIST_REQUEST_COUNT_TREND_1H = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,count(*) as count group by time order by time"
DOMAIN_NAME_LIST_REQUEST_COUNT_TREND_7D = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,count(*) as count group by time order by time"
DOMAIN_NAME_LIST_REQUEST_COUNT_TREND_24H = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,count(*) as count group by time order by time"
DOMAIN_NAME_LIST_REQUEST_COUNT_TREND_1H = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,count(*) as count group by time order by time"

NAME_LIST_IP_COUNT_TREND_7D = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
NAME_LIST_IP_COUNT_TREND_24H = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
NAME_LIST_IP_COUNT_TREND_1H = "*  and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_NAME_LIST_IP_COUNT_TREND_7D = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_NAME_LIST_IP_COUNT_TREND_24H = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
DOMAIN_NAME_LIST_IP_COUNT_TREND_1H = "* and host: \"{}\" and (waf_module: global_name_list or waf_module: name_list) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,count(DISTINCT src_ip) as count group by time order by time"
...
def sls_report_name_list_request_count_trend(request):
    return_result = {}
    try:
...
def sls_report_name_list_ip_count_trend(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_request_count_totle(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_request_ip_totle(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_att_type_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_att_ip_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_att_uri_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
...
def sls_report_name_list_att_ip_country_top10(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        json_data = json.loads(request.body)
