...
def soc_web_report_attack_count_total(request):
    return_result = {}
    try:
...
def soc_web_report_attack_api_count_total(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_isocode_count_total(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_city_count_total(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_geoip(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_city_geoip(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_count_trend(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_api_top(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_type_top(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_ip_top(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_isocode_top(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
...
def soc_web_report_attack_city_top(request):
    return_result = {}
    try:
        user_id = request.session['user_id']
        sys_conf_result = sys_conf.objects.get(user_id=user_id)
