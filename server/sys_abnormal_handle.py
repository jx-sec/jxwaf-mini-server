...
def waf_edit_sys_abnormal_handle(request):
    ...
    try:
        ...
        client_body_size_check = json_data['client_body_size_check']
        ...
        sys_abnormal_handle.objects.filter(user_id=user_id).update(
            ...
            ssl_attack_block_name_list_uuid=ssl_attack_block_name_list_uuid,client_body_size_check=client_body_size_check)
...
def waf_get_sys_abnormal_handle(request):
    ...
    try:
        ...
        try:
            ...
            sys_abnormal_handle.objects.filter(user_id=user_id).delete()
            sys_abnormal_handle.objects.create(user_id=user_id)
            sys_abnormal_handle_result = sys_abnormal_handle.objects.get(user_id=user_id)
        ...
        data['client_body_size_check'] = sys_abnormal_handle_result.client_body_size_check
