...
UPSTREAM_INPUT_TREND_7D = "*  and (not upstream_addr: -) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
UPSTREAM_INPUT_TREND_24H = "*  and (not upstream_addr: -) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
UPSTREAM_INPUT_TREND_1H = "*  and (not upstream_addr: -) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
...
DOMAIN_UPSTREAM_INPUT_TREND_7D = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'1d', '%m-%d-%H', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
DOMAIN_UPSTREAM_INPUT_TREND_24H = "* and (not upstream_addr: -) and host: \"%s\" | select time_series(request_time,'1h','%m-%d-%H', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
DOMAIN_UPSTREAM_INPUT_TREND_1H = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'5m', '%H:%i:%s', '0') as time,sum(upstream_bytes_sent) as count group by time order by time"
# req output byte
...
UPSTREAM_OUTPUT_TREND_7D = "*  and (not upstream_addr: -) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
UPSTREAM_OUTPUT_TREND_24H = "*  and (not upstream_addr: -) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
UPSTREAM_OUTPUT_TREND_1H = "*  and (not upstream_addr: -) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
...
DOMAIN_UPSTREAM_OUTPUT_TREND_7D = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'1d', '%m-%d-%H', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
DOMAIN_UPSTREAM_OUTPUT_TREND_24H = "* and (not upstream_addr: -) and host: \"%s\" | select time_series(request_time,'1h','%m-%d-%H', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
DOMAIN_UPSTREAM_OUTPUT_TREND_1H = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'5m', '%H:%i:%s', '0') as time,sum(upstream_bytes_received) as count group by time order by time"
# prossess time
...
UPSTREAM_PROCESS_TREND_7D = "*  and (not upstream_addr: -) | select time_series(request_time,'1d', '%m-%d-%H', '0') as time,avg(upstream_response_time) as count group by time order by time"
UPSTREAM_PROCESS_TREND_24H = "*  and (not upstream_addr: -) | select time_series(request_time,'1h','%m-%d-%H', '0') as time,avg(upstream_response_time) as count group by time order by time"
UPSTREAM_PROCESS_TREND_1H = "*  and (not upstream_addr: -) | select time_series(request_time,'5m', '%H:%i:%s', '0') as time,avg(upstream_response_time) as count group by time order by time"
...
DOMAIN_UPSTREAM_PROCESS_TREND_7D = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'1d', '%m-%d-%H', '0') as time,avg(upstream_response_time) as count group by time order by time"
DOMAIN_UPSTREAM_PROCESS_TREND_24H = "* and (not upstream_addr: -) and host: \"%s\" | select time_series(request_time,'1h','%m-%d-%H', '0') as time,avg(upstream_response_time) as count group by time order by time"
DOMAIN_UPSTREAM_PROCESS_TREND_1H = "* and (not upstream_addr: -)  and host: \"%s\"| select time_series(request_time,'5m', '%H:%i:%s', '0') as time,avg(upstream_response_time) as count group by time order by time"
# bad request count
